    ...
    <>
      ...
      {espacios.map((espacio, index) => (
        <div key={espacio.key}>
          <div
            id={espacio.key}
            className={`full-width-section min-h-screen lg:bg-fixed bg-no-repeat bg-cover bg-center grid grid-rows-3 lg:grid-rows-1 lg:grid-cols-12 ${styles[index].background}`}
          >
