...
const contentData = [
  ...
  },
  {
    ...
    content: (
      <>
        El Centro Educacional "Héroe Arturo Pérez Canto" inició sus actividades
        el 17 de septiembre de 1944 bajo el nombre de Escuela Experimental El
        Salto. En sus primeros años, se encontraba en un sector de chacras y
        quintas cerca de la Plaza El Salto, entre las calles Víctor Cuccuini y
        Américo Vespucio. Durante esa época, se fundó el{" "}
        <Link
  ...
  },
  {
    ...
    content: (
      <>
        ...
        primero como Escuela Centralizada, luego como Escuela Consolidada, y en
        los años 80, con la municipalización de la educación escolar, se
  ...
  },
  {
    ...
    content: (
      <>
        El liceo ha sido un pilar en la comunidad, organizando eventos como las
        Fiestas de la Primavera, campeonatos deportivos, festivales de música
        folclórica y teatro. La comunidad también recuerda con cariño la música
        pascuense interpretada por familias originarias de la{" "}
        <Link
  ...
  },
  {
    ...
    content: (
      <>
        ...
        , un programa destinado a ofrecer apoyo integral a los estudiantes y sus
        familias.
      </>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <>
        ...
        promoviendo el desarrollo integral de los estudiantes en un ambiente de
        participación y convivencia democrática. Su misión es fomentar el
  ...
  },
  {
    ...
    content: (
      <>
        El reglamento interno del liceo establece principios fundamentales como
        el respeto, la responsabilidad, la solidaridad, la empatía y la
        ...
        inclusión y la no discriminación, adoptando normativas y protocolos para
        asegurar un entorno seguro y respetuoso para todos los estudiantes.
      </>
    ),
  },
  {
